...
```bash
./.agents/skills/openspec-buddy/scripts/create-series-parent.sh <series-name> [title]
```
...
```bash
./.agents/skills/openspec-buddy/scripts/close-completed-series-parent.sh <child-or-parent-issue>
```
...
```bash
./.agents/skills/openspec-buddy/scripts/link-issue-dependencies.sh <issue-A> <issue-B>
```
...
```bash
./.agents/skills/openspec-buddy/scripts/list-ready-change-relationships.sh 100
node ./.agents/skills/openspec-buddy/scripts/verify-issue-relationships.mjs < relationships.json
```
...
```bash
./.agents/skills/openspec-buddy/scripts/set-project-date.sh <issue> Start YYYY-MM-DD
./.agents/skills/openspec-buddy/scripts/set-project-date.sh <issue> End YYYY-MM-DD
```

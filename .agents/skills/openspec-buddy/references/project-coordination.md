...
```bash
./.agents/skills/openspec-buddy/scripts/configure-pr-metadata.sh <issue-number> <pr-number-or-url>
```
...
```bash
./.agents/skills/openspec-buddy/scripts/set-status-label.sh <issue-number> <status:label>
```
